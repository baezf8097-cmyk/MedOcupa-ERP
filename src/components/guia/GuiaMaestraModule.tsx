...
import { 
  ...
  Building2, Plus, Calendar, CheckSquare, Edit3, Save, X, Upload, FilePlus, Eye, Trash2, Paperclip
} from 'lucide-react';
...
export const GuiaMaestraModule: React.FC<GuiaMaestraModuleProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'matriz' | 'capacitaciones'>('matriz');
  ...
  return (
    <div className="space-y-6">
      ...
      {/* NAVIGATION TABS */}
      <div className="bg-slate-950 p-2 rounded-xl border border-slate-800 flex items-center justify-between gap-4">
        <div className="flex items-center gap-1">
          ...
          >
            ...
            <span>Matriz de los 10 Pilares (Guía Maestra)</span>
          </button>
          ...
          >
            ...
            <span>Pilar 8: Capacitaciones Ocupacionales ({capacitaciones.length})</span>
          </button>
        </div>
