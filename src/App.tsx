...
export default function App() {
  ...
  const handleSaveProfile = async (updatedUser: User) => {
    ...
    addAuditLog('ACTUALIZAR_PERFIL_PROFESIONAL', `Perfil actualizado: ${updatedUser.nombre} (${updatedUser.cmp_rnm || updatedUser.cep || ''})`);
    ...
    if (token) {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.message || 'No se pudo guardar la información en el servidor');
      }
    }
  };
